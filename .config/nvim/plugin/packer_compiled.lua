...
_G.packer_plugins = {
  ...
  ["cmp-copilot"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/cmp-copilot",
  ...
  neorg = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/neorg",
    url = "https://github.com/nvim-neorg/neorg"
  },
  ["neorg-telescope"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/neorg-telescope",
  ...
  ["oh-lucy.nvim"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/oh-lucy.nvim",
