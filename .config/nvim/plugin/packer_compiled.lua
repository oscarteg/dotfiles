...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["go.nvim"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/go.nvim",
  ...
  ["lsp-format.nvim"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/lsp-format.nvim",
  ...
  ["mind.nvim"] = {
    ...
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/mind.nvim",
  ...
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
  ...
  ["vim-test"] = {
    loaded = true,
    path = "/Users/oscar/.local/share/nvim/site/pack/packer/start/vim-test",
